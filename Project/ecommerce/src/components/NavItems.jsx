            ...
            <div className="menu-area">
              <div className="menu">
                <ul className={`lab-ul ${menuToggle ? "active" : ""}`}>
                  ...
                  <li>
                    {" "}
                    <NavLink to="/about"   onClick={() => setMenuToggle(!menuToggle)}>About</NavLink>
                  </li>
                  <li>
                    <NavLink to="/contact"   onClick={() => setMenuToggle(!menuToggle)}>Contact</NavLink>
                  </li>
                </ul>
              </div>
                ...
                <>
                  <div>
                    {user?.photoURL ? (
                      ...
                      <img
                        src="https://i.ibb.co/SRPVm2P/02.jpg"
